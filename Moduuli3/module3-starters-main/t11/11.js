...
// add your code here
let targetelement = document.getElementById("pictures")
for(let i = 0; i < picArray.length; i++)
{
  let h2element = document.createElement("h2")
  let h2text = document.createTextNode(picArray[i].title)
  ...
  let descriptionText = document.createTextNode(picArray[i].description)
...
for(let i = 0; i < picArray.length; i++)
{
    update[i].onclick = event
}
var imageplace = document.querySelector("dialog > img")
imageplace.src = picArray[Math.floor(Math.random() * picArray.length + 1)].image.large;
imageplace.alt = "randomimage";
